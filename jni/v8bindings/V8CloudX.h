...
public:
    ...
    static v8::Handle<v8::Value> GetCanvas(const Arguments& args);
    static v8::Handle<v8::Value> CreateCanvas(const Arguments& args);
    static v8::Handle<v8::Value> GetCamera(const Arguments& args);
    static v8::Handle<v8::Value> GetAudio(const Arguments& args);
    static v8::Handle<v8::Value> GetArguments(const v8::Arguments& args);
    static v8::Handle<v8::Value> SetArguments(const v8::Arguments& args);
    static v8::Handle<v8::Value> CreateSoundPool(const v8::Arguments& args);
    static v8::Handle<v8::Value> GetDataBase(const v8::Arguments& args);
private:
