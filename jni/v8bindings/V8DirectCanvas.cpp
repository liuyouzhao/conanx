...
v8::Handle<v8::Value> V8DirectCanvas::OnDestroy(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8DirectCanvas::OnFrame(const v8::Arguments& args)
{
    v8::HandleScope scope;
...
v8::Handle<v8::Value> V8DirectCanvas::SetUsed(const v8::Arguments& args)
{
    v8::HandleScope scope;
