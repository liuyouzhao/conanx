...
public:
    ...
    static v8::Handle<v8::Value> SetUsed(const v8::Arguments& args);
    
    static v8::Handle<v8::Value> OnFrame(const v8::Arguments&);
    static v8::Handle<v8::Value> OnDestroy(const v8::Arguments&);
