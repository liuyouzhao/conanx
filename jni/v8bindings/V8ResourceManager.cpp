...
v8::Handle<v8::Value> V8ResourceManager::LoadImageResource(const v8::Arguments& args) {
...
v8::Handle<v8::Value> V8ResourceManager::LoadSoundResource(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
...
v8::Handle<v8::Value> V8ResourceManager::ReleaseResource(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
...
/// images
v8::Handle<v8::Value> V8ResourceManager::GetImageData(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
...
v8::Handle<v8::Value> V8ResourceManager::GetImageWidth(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
	...
	int id = args[0]->NumberValue();
	jint width = (jint) s_JNIEnv->CallStaticObjectMethod(JRMClass, jmethod, id);

	return v8::Int32::New(width);
}

v8::Handle<v8::Value> V8ResourceManager::GetImageHeight(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
	...
	int id = args[0]->NumberValue();
	jint height = (jint) s_JNIEnv->CallStaticIntMethod(JRMClass, jmethod, id);

	return v8::Int32::New(height);
}

  /// sounds
v8::Handle<v8::Value> V8ResourceManager::PlaySound(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
...
v8::Handle<v8::Value> V8ResourceManager::StopSound(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
...
v8::Handle<v8::Value> V8ResourceManager::PauseSound(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
...
v8::Handle<v8::Value> V8ResourceManager::ResumeSound(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
...
v8::Handle<v8::Value> V8ResourceManager::SetSoundVolume(const v8::Arguments& args) {
	jclass JRMClass = s_JNIEnv->FindClass(CLASS_NAME);
