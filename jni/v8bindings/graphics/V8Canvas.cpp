...
v8::Handle<v8::Value> V8Canvas::SetLayer(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8Canvas::GetContext(const Arguments& args)
{
	unsigned int numArgs = args.Length();
...
v8::Handle<v8::Value> V8Canvas::Wrap(const Arguments& args)
{
	/*
