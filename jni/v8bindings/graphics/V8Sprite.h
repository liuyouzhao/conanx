...
public:
    ...
    static v8::Handle<v8::Value> SpriteConstructor(const v8::Arguments& args);
    ...
    static v8::Handle<v8::Value> RenderEx(const v8::Arguments& args);
    static v8::Handle<v8::Value> SetColor(const v8::Arguments& args);
    static v8::Handle<v8::Value> SetHotSpot(const v8::Arguments& args);
    static v8::Handle<v8::Value> SetBlendMode(const v8::Arguments& args);
    static v8::Handle<v8::Value> SetTexture(const v8::Arguments& args);
    static v8::Handle<v8::Value> SetUV(const v8::Arguments& args);
