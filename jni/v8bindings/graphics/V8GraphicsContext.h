...
public:
    ...
    static v8::Handle<v8::Value> Wrap(const Arguments& args, int canvasId);
    static v8::Handle<v8::Value> Wrap(RenderingContext* ptr);

    //javascript functions
    static v8::Handle<v8::Value> SetClearColor(const v8::Arguments& args);
    static v8::Handle<v8::Value> Clear(const v8::Arguments& args);
    static v8::Handle<v8::Value> DrawBoxEx(const v8::Arguments& args);

    static v8::Handle<v8::Value> SwapBuffer(const v8::Arguments& args);
    static v8::Handle<v8::Value> SetColor(const v8::Arguments& args);
    static v8::Handle<v8::Value> ClearImage(const v8::Arguments& args);
    static v8::Handle<v8::Value> SetColorEx(const v8::Arguments& args);

    static v8::Handle<v8::Value> FillText(const v8::Arguments& args);
    static v8::Handle<v8::Value> StrokeText(const v8::Arguments& args);
...
//rect
    ...
    static v8::Handle<v8::Value> ClearRect(const v8::Arguments& args);
    ...
    static v8::Handle<v8::Value> CreateImageData(const v8::Arguments& args);
    static v8::Handle<v8::Value> GetImageData(const v8::Arguments& args);
    static v8::Handle<v8::Value> PutImageData(const v8::Arguments& args);

    static v8::Handle<v8::Value> Fill(const v8::Arguments &args);
    static v8::Handle<v8::Value> Stroke(const v8::Arguments &args);
    static v8::Handle<v8::Value> Clip(const v8::Arguments &args);
    ...
    static v8::Handle<v8::Value> QuadraticCurveTo(const v8::Arguments& args);
    static v8::Handle<v8::Value> BezierCurveTo(const v8::Arguments& args);
    static v8::Handle<v8::Value> IsPointInPath(const v8::Arguments &args);
    ...
    static v8::Handle<v8::Value> CreatePattern(const v8::Arguments &args);
    static v8::Handle<v8::Value> CreateLinearGradient(const v8::Arguments &args);
    static v8::Handle<v8::Value> CreateRadialGradient(const v8::Arguments &args);

    static v8::Handle<v8::Value> DrawCameraPreview(const v8::Arguments &args);
    static v8::Handle<v8::Value> DrawWebView(const v8::Arguments &args);
private:
};
