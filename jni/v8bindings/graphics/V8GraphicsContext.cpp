...
**/
v8::Handle<v8::Value> V8GraphicsContext::Wrap(const Arguments& args, int canvasId)
{
...
v8::Handle<v8::Value> V8GraphicsContext::SetClearColor(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8GraphicsContext::Clear(const v8::Arguments& args)
{
    HandleScope scope;
    if (0 != args.Length())
...
v8::Handle<v8::Value> V8GraphicsContext::DrawBoxEx(const v8::Arguments& args)
{
    HandleScope scope;
    GraphicsContext *gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
...
/// draw Image
v8::Handle<v8::Value> V8GraphicsContext::DrawImage(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8GraphicsContext::SetColor(const v8::Arguments& args)
{
    HandleScope scope;
    GraphicsContext *gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
    float r = args[0]->NumberValue();
...
v8::Handle<v8::Value> V8GraphicsContext::SetColorEx(const v8::Arguments& args)
{
    HandleScope scope;
    GraphicsContext *gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
    float color[4][4];
...
v8::Handle<v8::Value> V8GraphicsContext::ClearImage(const v8::Arguments& args)
{
    HandleScope scope;
    GraphicsContext *gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
    gc->clearImage();
...
v8::Handle<v8::Value> V8GraphicsContext::SwapBuffer(const v8::Arguments& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> V8GraphicsContext::FillRect(const v8::Arguments& args)
{
    HandleScope scope;
    GraphicsContext *gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
...
v8::Handle<v8::Value> V8GraphicsContext::FillText(const v8::Arguments& args)
{
    HandleScope scope;
    if (3 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::StrokeText(const v8::Arguments& args)
{
    HandleScope scope;
    if (3 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::ClearRect(const v8::Arguments& args)
{
    HandleScope scope;
    GraphicsContext *gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
    if (4 != args.Length())
...
v8::Handle<Value> V8GraphicsContext::StrokeRect(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8GraphicsContext::Save(const v8::Arguments &args)
{
    HandleScope scope;
    if (0 != args.Length())
...
v8::Handle<v8::Value> V8GraphicsContext::Restore(const v8::Arguments &args)
{
    HandleScope scope;
    if (0 != args.Length())
...
v8::Handle<v8::Value> V8GraphicsContext::CreateImageData(const v8::Arguments& args)
{
    HandleScope scope;
    GraphicsContext* gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
...
v8::Handle<v8::Value> V8GraphicsContext::GetImageData(const v8::Arguments& args)
{
    HandleScope scope;
    GraphicsContext* gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
    return V8ImageData::Wrap(args, gc->GetContext());
...
v8::Handle<v8::Value> V8GraphicsContext::PutImageData(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8GraphicsContext::Fill(const v8::Arguments &args)
{
    HandleScope scope;
    if (0 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::Stroke(const v8::Arguments &args)
{
    HandleScope scope;
    if (0 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::Clip(const v8::Arguments &args)
{
    HandleScope scope;
    if (0 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::BeginPath(const v8::Arguments &args)
{
    HandleScope scope;
    if (0 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::ClosePath(const v8::Arguments &args)
{
    HandleScope scope;
    if (0 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::MoveTo(const v8::Arguments &args)
{
    HandleScope scope;
    GraphicsContext* gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
...
v8::Handle<v8::Value> V8GraphicsContext::LineTo(const v8::Arguments &args)
{
    HandleScope scope;
    if (2 != args.Length())
    {
...
v8::Handle<v8::Value> V8GraphicsContext::Translate(const v8::Arguments &args)
{
    HandleScope scope;
    if (2 != args.Length())
    {
...
v8::Handle<v8::Value> V8GraphicsContext::Scale(const v8::Arguments &args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8GraphicsContext::Rotate(const v8::Arguments &args)
{
    HandleScope scope;
    if (1 != args.Length())
    {
...
v8::Handle<v8::Value> V8GraphicsContext::Transform(const v8::Arguments &args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8GraphicsContext::SetTransform(const v8::Arguments &args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8GraphicsContext::Arc(const v8::Arguments &args)
{
    HandleScope scope;
    if (6 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::QuadraticCurveTo(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8GraphicsContext::BezierCurveTo(const v8::Arguments& args)
{
    HandleScope scope;
    if (6 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::IsPointInPath(const Arguments& args)
{
    HandleScope scope;
    if (2 != args.Length())
        return THROW_EXCEPTION(TError,
...
v8::Handle<v8::Value> V8GraphicsContext::CreatePattern(const Arguments& args)
{
    HandleScope scope;
    GraphicsContext* gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
...
v8::Handle<v8::Value> V8GraphicsContext::CreateLinearGradient(const Arguments& args)
{
    HandleScope scope;
    GraphicsContext* gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
...
v8::Handle<v8::Value> V8GraphicsContext::CreateRadialGradient(const Arguments& args)
{
    HandleScope scope;
    GraphicsContext* gc = ObjectWrap::Unwrap<GraphicsContext>(args.This());
    return CanvasGradient::wrap(args, gc->GetContext(), gc->getCanvasId());
...
v8::Handle<v8::Value> V8GraphicsContext::DrawCameraPreview(const v8::Arguments &args)
{
    HandleScope scope;
...
/*
v8::Handle<v8::Value> V8GraphicsContext::DrawWebView(const v8::Arguments &args)
{
