...
v8::Handle<v8::Value> V8Sprite::SpriteConstructor(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Sprite::Render(const v8::Arguments& args)
{
	HandleScope scope;
...
v8::Handle<v8::Value> V8Sprite::RenderEx(const v8::Arguments& args)
{
	HandleScope scope;
...
v8::Handle<v8::Value> V8Sprite::SetColor(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Sprite::SetHotSpot(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Sprite::SetTexture(const v8::Arguments& args)
{
	//void        SetHotSpot(int x, int y);
	HandleScope scope;
...
v8::Handle<v8::Value> V8Sprite::SetUV(const v8::Arguments& args)
{
