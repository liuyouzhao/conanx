...
v8::Handle<v8::Value> V8Orc2d::System_Initiate(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8Orc2d::System_Shutdown(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8Orc2d::System_ChangeSize(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8Orc2d::System_GetErrorMessage(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8Orc2d::Effect_Load(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Effect_Free(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Effect_Free_All(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Effect_Active(const v8::Arguments& args)
{
 ...
 * */
v8::Handle<v8::Value> V8Orc2d::Effect_SetFloat(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Effect_SetFloatv2(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Effect_SetInt(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Gfx_SetClearColor(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Gfx_SetLineWidth(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Gfx_Clear(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Gfx_RenderLine(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Gfx_RenderTripleEx(const v8::Arguments& args)
{
	/*
...
v8::Handle<v8::Value> V8Orc2d::Gfx_RenderQuadEx(const v8::Arguments& args)
{
	/*
	 * virtual void        CALL    Gfx_RenderQuadEx(float x1, float y1, float x2, float y2,
                                               float x3, float y3, float x4, float y4,
...
v8::Handle<v8::Value> V8Orc2d::Gfx_RenderRoundEx(const v8::Arguments& args)
{
	/*
...
v8::Handle<v8::Value> V8Orc2d::Gfx_RenderTorusEx(const v8::Arguments& args)
{
	/*
...
v8::Handle<v8::Value> V8Orc2d::Gfx_SwapBuffer(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8Orc2d::Texture_Create(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Texture_Load(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Texture_Free(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Texture_SaveToFile(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Transform_rotate(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Transform_translate(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Transform_scale(const v8::Arguments& args)
{
...
v8::Handle<v8::Value> V8Orc2d::Transform_scaleNonUniform(const v8::Arguments& args)
{
