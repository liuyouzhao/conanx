...
v8::Handle<v8::Value> V8CloudX::CreateCanvas(const Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8CloudX::GetCanvas(const Arguments& args)
{
    HandleScope scope;
    ClassImpl* pImpl = ObjectWrap::Unwrap<ClassImpl>(args.This());
...
v8::Handle<v8::Value> V8CloudX::GetCamera(const Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8CloudX::GetAudio(const Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> V8CloudX::CreateSoundPool(const v8::Arguments& args)
{
    HandleScope scope;
    return SoundPoolIns::wrap(args);
}

v8::Handle<v8::Value> V8CloudX::GetArguments(const v8::Arguments& args)
{
    HandleScope scope;
    if (args.Length() >= 1)
...
v8::Handle<v8::Value> V8CloudX::SetArguments(const v8::Arguments& args)
{
    HandleScope scope;
    if (args.Length() != 1)
...
v8::Handle<v8::Value> V8CloudX::GetDataBase(const v8::Arguments& args)
{
    HandleScope scope;
    if (args.Length() != 0)
