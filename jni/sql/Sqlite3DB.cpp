...
v8::Handle<v8::Value> SQLite3DB::ExecDML(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> SQLite3DB::SQLiteVersion(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
...
v8::Handle<v8::Value> SQLite3DB::CompileStatement(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1 || !args[0]->IsString())
...
v8::Handle<v8::Value> SQLite3DB::GetTable(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1 || !args[0]->IsString())
...
v8::Handle<v8::Value> SQLite3DB::ExecQuery(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1 || !args[0]->IsString())
...
v8::Handle<v8::Value> SQLite3DB::TableExists(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1 || !args[0]->IsString())
...
v8::Handle<v8::Value> SQLite3DB::ExecScalar(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1 || !args[0]->IsString())
...
v8::Handle<v8::Value> SQLite3DB::LastRowId(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
