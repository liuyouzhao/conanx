...
v8::Handle<v8::Value> SQLite3Statement::ExecDML(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
...
v8::Handle<v8::Value> SQLite3Statement::ExecQuery(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
...
v8::Handle<v8::Value> SQLite3Statement::Bind(const v8::Arguments& args)
{
    HandleScope scope;
    SQLite3Statement* stmt = ObjectWrap::Unwrap<SQLite3Statement>(args.This());
...
v8::Handle<v8::Value> SQLite3Statement::BindNull(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> SQLite3Statement::Reset(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
...
v8::Handle<v8::Value> SQLite3Statement::Finalize(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
