...
v8::Handle<v8::Value> SQLite3Query::NumFields(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
...
v8::Handle<v8::Value> SQLite3Query::FieldName(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> SQLite3Query::FieldDeclType(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1 || !args[0]->IsInt32())
...
v8::Handle<v8::Value> SQLite3Query::FieldIndex(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> SQLite3Query::FieldValue(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Query::GetIntField(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Query::GetFloatField(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Query::GetBlobField(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Query::FieldIsNull(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Query::Eof(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
...
v8::Handle<v8::Value> SQLite3Query::NextRow(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
...
v8::Handle<v8::Value> SQLite3Query::Finalize(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
