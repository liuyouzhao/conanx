...
v8::Handle<v8::Value> SQLite3Table::FieldName(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> SQLite3Table::NumFields(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
...
v8::Handle<v8::Value> SQLite3Table::FieldValue(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Table::GetIntField(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Table::GetFloatField(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Table::GetStringField(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Table::FieldIsNull(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Table::NumRows(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
...
v8::Handle<v8::Value> SQLite3Table::SetRow(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 1)
...
v8::Handle<v8::Value> SQLite3Table::Finalize(const v8::Arguments& args)
{
    HandleScope scope;
    if(args.Length() != 0)
