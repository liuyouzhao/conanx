...
v8::Handle<v8::Value> XMLHttpRequest::Open(const v8::Arguments& args)
{
    HandleScope scope;
...
v8::Handle<v8::Value> XMLHttpRequest::Send(const v8::Arguments& args)
{
    HandleScope scope;
    XMLHttpRequest *request = ObjectWrap::Unwrap<XMLHttpRequest>(args.This());
    if (args.Length() == 0)
...
v8::Handle<v8::Value> XMLHttpRequest::GetAllResponseHeaders(const v8::Arguments& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> XMLHttpRequest::GetResponseHeader(const v8::Arguments& args)
{
    HandleScope scope;
    if (args.Length() != 1)
    {
...
v8::Handle<v8::Value> XMLHttpRequest::SetRequestHeader(const v8::Arguments& args)
{
    HandleScope scope;
    if (args.Length() != 2)
    {
...
v8::Handle<v8::Value> XMLHttpRequest::Abort(const v8::Arguments& args)
{
    HandleScope scope;
    if (args.Length() != 0)
    {
...
v8::Handle<v8::Value> XMLHttpRequest::AjaxCreate(const v8::Arguments& args)
{
