...
public:
    ...
    static Handle<v8::Value> WebSocketCreate(const Arguments& args);
    ...
    static Handle<v8::Value> Send(const Arguments& args);
    static Handle<v8::Value> Close(const Arguments& args);
