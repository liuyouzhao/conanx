...
v8::Handle<v8::Value> WebSocketImpl::WebSocketCreate(const v8::Arguments& args)
{
...
Handle<v8::Value> WebSocketImpl::Send(const Arguments& args)
{
    HandleScope scope;
...
Handle<v8::Value> WebSocketImpl::Close(const Arguments& args)
{
    HandleScope scope;
    if (args.Length() >= 1)
    {
