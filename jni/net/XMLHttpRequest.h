...
public:
    ...
    static v8::Handle<v8::Value> AjaxCreate(const v8::Arguments& args);
    ...
    static v8::Handle<v8::Value> GetAllResponseHeaders(const v8::Arguments& args);
    static v8::Handle<v8::Value> GetResponseHeader(const v8::Arguments& args);
    static v8::Handle<v8::Value> SetRequestHeader(const v8::Arguments& args);
