...
v8::Handle<v8::Value> CanvasGradient::wrap(const Arguments& args, Gl2d_Impl* gc, int canvasId)
{
    HandleScope scope;
...
v8::Handle<v8::Value> CanvasGradient::addColorStop(const Arguments& args)
{
    HandleScope scope;
    if (2 != args.Length())
